...
execute at @a[tag=Boss_Fighting] run summon bee ~ ~1 ~10 {NoAI:1b,Invulnerable:1b,Tags:["1_15_bee","CooldownRequired"],Rotation:[180.0f,0.0f],PortalCooldown:50}
execute at @a[tag=Boss_Fighting] run summon bee ~7.071 ~1 ~7.071 {NoAI:1b,Invulnerable:1b,Tags:["1_15_bee","CooldownRequired"],Rotation:[135.0f,0.0f],PortalCooldown:50}
execute at @a[tag=Boss_Fighting] run summon bee ~10 ~1 ~ {NoAI:1b,Invulnerable:1b,Tags:["1_15_bee","CooldownRequired"],Rotation:[90.0f,0.0f],PortalCooldown:50}
execute at @a[tag=Boss_Fighting] run summon bee ~7.071 ~1 ~-7.071 {NoAI:1b,Invulnerable:1b,Tags:["1_15_bee","CooldownRequired"],Rotation:[45.0f,0.0f],PortalCooldown:50}
execute at @a[tag=Boss_Fighting] run summon bee ~ ~1 ~-10 {NoAI:1b,Invulnerable:1b,Tags:["1_15_bee","CooldownRequired"],Rotation:[0.0f,0.0f],PortalCooldown:50}
execute at @a[tag=Boss_Fighting] run summon bee ~-7.071 ~1 ~-7.071 {NoAI:1b,Invulnerable:1b,Tags:["1_15_bee","CooldownRequired"],Rotation:[-45.0f,0.0f],PortalCooldown:50}
execute at @a[tag=Boss_Fighting] run summon bee ~-10 ~1 ~ {NoAI:1b,Invulnerable:1b,Tags:["1_15_bee","CooldownRequired"],Rotation:[-90.0f,0.0f],PortalCooldown:50}
execute at @a[tag=Boss_Fighting] run summon bee ~-7.071 ~1 ~7.071 {NoAI:1b,Invulnerable:1b,Tags:["1_15_bee","CooldownRequired"],Rotation:[-135.0f,0.0f],PortalCooldown:50}

...
#> メッセージ2
execute if score Count MakeupTick matches 82 run function time_limit:boss/newstar_king/makeup/message2
...
#> 3
execute if score Count MakeupTick matches 242 run function time_limit:boss/newstar_king/makeup/countdown

#> 2
execute if score Count MakeupTick matches 262 run function time_limit:boss/newstar_king/makeup/countdown

#> 1
execute if score Count MakeupTick matches 282 run function time_limit:boss/newstar_king/makeup/countdown

#> 魔法陣出現
execute if score Count MakeupTick matches 302 run function time_limit:boss/newstar_king/makeup/sound2
execute if score Count MakeupTick matches 302..342 run function time_limit:boss/newstar_king/makeup/particle1

#> summon
execute if score Count MakeupTick matches 343.. run function time_limit:boss/newstar_king/makeup/summon
execute if score Count MakeupTick matches ..343 run schedule function time_limit:boss/newstar_king/makeup/ 1t
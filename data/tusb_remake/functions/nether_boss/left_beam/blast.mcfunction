...
execute if score Difficulty Option matches 4 run execute as @e[tag=LeftEyeBlast] at @s positioned ~ ~3.5 ~ run summon minecraft:creeper ~ ~ ~ {Fuse:0s,ExplosionRadius:5b,Invulnerable:true,DeathTime:19s,CustomName:'"ドラゴンゲイズ"'}

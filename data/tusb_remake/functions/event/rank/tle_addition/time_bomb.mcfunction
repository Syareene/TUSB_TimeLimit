...
summon spawner_minecart ~ ~1 ~ {Tags:["CooldownRequired"],PortalCooldown:10,SpawnCount:2,SpawnRange:25,MinSpawnDelay:10,MaxSpawnDelay:10,MaxNearbyEntities:99,RequiredPlayerRange:999,SpawnData:{entity:{id:"minecraft:silverfish",PortalCooldown:301,Health:300f,Tags:["CooldownRequired"],Passengers:[{id:"minecraft:creeper",DeathLootTable:"usb:events/shadow",Health:300f,ExplosionRadius:5b,Fuse:300,ignited:1b,Tags:["TypeChecked","RidingRequired"],Attributes:[{Name:generic.max_health,Base:300}]}],Attributes:[{Name:generic.max_health,Base:300},{Name:generic.movement_speed,Base:0}]}}}
...
execute if score @s MobCastTime matches 11..14 run function tusb_remake:enemy/skill/shinsei/time_manipulation/
execute if score @s MobCastTime matches 15..17 run function tusb_remake:enemy/skill/shinen/reincarnate
execute if score @s MobCastTime matches 19 run function tusb_remake:enemy/skill/shinsei/acceleration